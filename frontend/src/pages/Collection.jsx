...
const Collection = () => {
  ...
  const applyFilterAndSort = () => {
    ...
    switch (sortType) {
      ...
      default:
        // 'relevant' - no specific sorting, maybe keep original order
        break
    }
  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t border-black/10'>

      {/* Filter Options */}
      <div className='min-w-60'>
        <p onClick={() => setShowFilter(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2 text-[#666666]'>Filtreler
          <img className={`h-2 sm:hidden ${showFilter ? 'rotate-0' : 'rotate-270'}`} src={assets.dropdownIcon} alt="" />
        </p>
